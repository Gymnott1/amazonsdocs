...
::code-preview{class="[&>div]:*:my-0 [&>div]:*:w-full"}
  ...
  Look at the [Nuxt documentation](https://nuxt.com/docs/introduction/overview/introduction) to learn more.
...
---
target: _blank
to: https://ui.nuxt.com/introduction/overview/typography#codetree
---
