...
This is only a basic example of what you can achieve with [Nuxt UI](https://ui.nuxt.com), you can tweak it to match your needs. The template uses several Nuxt modules underneath like [`@nuxt/content`](https://content.nuxt.com) for the content and [`nuxt-og-image`](https://nuxtseo.com/og-image/introduction/overview/installation) for social previews.

::tip
---
target: _blank
to: https://ui.nuxt.com/introduction/overview/installation
---
