...
- [Documentation](https://ui.nuxt.com/docs/introduction/overview/installation)
...
Check out the [deployment documentation](https://nuxt.com/docs/introduction/overview/deployment) for more information.
